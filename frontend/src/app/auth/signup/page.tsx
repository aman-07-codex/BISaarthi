  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-[#F8FAFC] dark:bg-[#0B0F17] text-slate-900 dark:text-slate-100">
      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8">
        <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-12 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xl overflow-hidden min-h-[620px]">
            ...
            <div>
              ...
              <form onSubmit={handleSignupSubmit} className="space-y-3.5" noValidate>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      } bg-slate-50 dark:bg-slate-800/80 text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#2563EB] focus:border-transparent transition-all`}
                    />
                  </div>
                  {fieldErrors.fullName && (
                    <p className="text-[11px] text-red-600 dark:text-red-400 pl-1">{fieldErrors.fullName}</p>
                  )}
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  {fieldErrors.email && (
                    <p className="text-[11px] text-red-600 dark:text-red-400 pl-1">{fieldErrors.email}</p>
                  )}
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  {fieldErrors.password && (
                    <p className="text-[11px] text-red-600 dark:text-red-400 pl-1">{fieldErrors.password}</p>
                  )}
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  {fieldErrors.confirmPassword && (
                    <p className="text-[11px] text-red-600 dark:text-red-400 pl-1">{fieldErrors.confirmPassword}</p>
                  )}
                </div>
              ...
              {/* Sign in link */}
              <div className="pt-5 text-center text-xs text-slate-600 dark:text-slate-400">
