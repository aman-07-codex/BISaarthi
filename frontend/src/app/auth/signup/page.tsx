...
function SignupForm() {
  ...
  const handleSignupSubmit = async (e: React.FormEvent) => {
    ...
    if (Object.keys(errors).length > 0) {
      ...
      if (errors.fullName) {
        setErrorMessage(errors.fullName);
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-[#F7F5EF] dark:bg-[#0E1815] text-[#18211D] dark:text-[#F7F5EF]">
      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8">
        <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-12 rounded-3xl bg-white dark:bg-[#15221E] border border-[#D9DDD8] dark:border-[#253831] shadow-xl overflow-hidden min-h-[620px]">
          ...
          <div className="lg:col-span-7 p-6 sm:p-10 lg:p-12 flex flex-col justify-between bg-white dark:bg-[#15221E]">
            <div>
              ...
              <div className="space-y-1.5 mb-6">
                <h1 className="text-2xl sm:text-3xl font-black text-[#18211D] dark:text-white tracking-tight">
                  Create your BISaarthi account
                </h1>
                <p className="text-xs sm:text-sm text-[#606E66] dark:text-[#BAC5BF]">
                  Get started with AI-powered guidance for Indian Standards.
                </p>
              </div>
              ...
              <form onSubmit={handleSignupSubmit} className="space-y-3.5" noValidate>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <User className="w-4 h-4 text-[#8B978F] absolute left-3.5 top-1/2 -translate-y-1/2 pointer-events-none" />
                    <input
                      type="text"
                      value={fullName}
                      onChange={(e) => {
                      ...
                      className={`w-full pl-10 pr-4 py-2.5 text-xs sm:text-sm rounded-full border ${
                        fieldErrors.fullName
                          ? 'border-[#C86D51] ring-1 ring-[#C86D51]'
                          : 'border-[#D9DDD8] dark:border-[#253831]'
                      } bg-[#FAF9F5] dark:bg-[#1B2B26] text-[#18211D] dark:text-[#F7F5EF] placeholder-[#8B978F] focus:outline-none focus:ring-2 focus:ring-[#5B8272]/30 focus:border-[#0D3328] transition-all`}
                    />
                  </div>
                  {fieldErrors.fullName && (
                    <p className="text-[11px] text-[#C86D51] pl-3">{fieldErrors.fullName}</p>
                  )}
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  {fieldErrors.email && (
                    <p className="text-[11px] text-[#C86D51] pl-3">{fieldErrors.email}</p>
                  )}
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-10 py-2.5 text-xs sm:text-sm rounded-full border ${
                  ...
                  {fieldErrors.password && (
                    <p className="text-[11px] text-[#C86D51] pl-3">{fieldErrors.password}</p>
                  )}
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  {fieldErrors.confirmPassword && (
                    <p className="text-[11px] text-[#C86D51] pl-3">{fieldErrors.confirmPassword}</p>
                  )}
                </div>
            ...
            {/* Quick Demo Hint */}
            <div className="mt-6 pt-3 border-t border-[#EFECE6] dark:border-[#1C2E28] text-[11px] text-[#8B978F] text-center">
              <span>Demo Mode: Fill in the fields to test registration and access the dashboard.</span>
            </div>
          </div>
        </div>
      </div>
